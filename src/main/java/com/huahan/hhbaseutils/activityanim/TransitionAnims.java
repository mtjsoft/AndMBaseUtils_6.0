...
import com.huahan.hhbaseutils.activityanim.TransitionCompat.TransitionListener;
...
public abstract class TransitionAnims {
	...
	public TransitionAnims(Activity activity) 
	{
		mActivity = activity;
		//设置窗口的背景图，用来做渐变
		mBackground = activity.getResources().getDrawable(R.drawable.hh_activity_anim_default_background);
