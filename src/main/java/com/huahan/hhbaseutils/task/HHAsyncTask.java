 ...
 * </ul>
 */
public abstract class HHAsyncTask<Params, Progress, Result> {
...
//    		MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, sWorkQueue, sThreadFactory);
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                try {
                    ...
                    HHLog.i(LOG_TAG, "HHAsyncTask",e);
                } catch (ExecutionException e) {
                    throw new RuntimeException("An error occured while executing doInBackground()",
                            e.getCause());
                } catch (CancellationException e) {
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new AsyncTaskResult<Result>(HHAsyncTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new AsyncTaskResult<Result>(HHAsyncTask.this, result));
                message.sendToTarget();
            }
        };
    }
	...
	public final HHAsyncTask<Params, Progress, Result> execute(Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
		...
		final HHAsyncTask mTask;
        final Data[] mData;

        @SuppressWarnings("rawtypes")
		AsyncTaskResult(HHAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
