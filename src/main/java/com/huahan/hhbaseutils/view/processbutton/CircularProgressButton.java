...
public class CircularProgressButton extends Button {
    ...
    private OnCompleteAnimFinishListener mCompleteAnimFinishListener; 

    public void setOnCompleteAnimFinishListener(OnCompleteAnimFinishListener listener)
    {
    	this.mCompleteAnimFinishListener=listener;
    }
    private enum State {
	...
	private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.hh_login_ing_background).mutate();
    ...
    private OnAnimationEndListener mCompleteStateListener = new OnAnimationEndListener() {
        ...
        public void onAnimationEnd() {
            ...
            if (mCompleteAnimFinishListener!=null)
			{
				mCompleteAnimFinishListener.onCompleteAnimFinished();
			}
            mStateManager.checkState(CircularProgressButton.this);
        }
    };
    ...
    public interface OnCompleteAnimFinishListener
    {
