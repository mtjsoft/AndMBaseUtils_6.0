...
/**
 * 使用该类的时候建议使用TabLayout实现。实现跟随ViewPager滑动而滑动，显示ViewPager的标题。
 * @author yuan
 *
 */
public class PagerSlidingTabStrip extends HorizontalScrollView
{
            ...
            int defStyle)
    {
        ...
        selectedTabTextSize = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, selectedTabTextSize, dm);
        ...
        indicatorColor = a.getColor(
                R.styleable.PagerSlidingTabStrip_pst_indicatorColor,
                indicatorColor);
        underlineColor = a.getColor(
                R.styleable.PagerSlidingTabStrip_pst_underlineColor,
                underlineColor);
        dividerColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_pst_dividerColor,
                        dividerColor);
        indicatorHeight = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pst_indicatorHeight,
                indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pst_underlineHeight,
                underlineHeight);
        dividerPadding = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pst_dividerPadding,
                dividerPadding);
        tabPadding = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pst_tabPaddingLeftRight,
                tabPadding);
        tabBackgroundResId = a.getResourceId(
                R.styleable.PagerSlidingTabStrip_pst_tabBackground,
                tabBackgroundResId);
        shouldExpand = a
                .getBoolean(R.styleable.PagerSlidingTabStrip_pst_shouldExpand,
                        shouldExpand);
        scrollOffset = a
                .getDimensionPixelSize(
                        R.styleable.PagerSlidingTabStrip_pst_scrollOffset,
                        scrollOffset);
        textAllCaps = a.getBoolean(
                R.styleable.PagerSlidingTabStrip_pst_textAllCaps, textAllCaps);
    ...
    public TextView getTabItem(int posi)
    {
        return (TextView) tabsContainer.getChildAt(posi);
    }

    public void setTabItem(int posi, String content)
    {
        TextView textView = (TextView) tabsContainer.getChildAt(posi);
