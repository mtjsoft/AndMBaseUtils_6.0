package com.huahan.hhbaseutils.view.GridPasswordView;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.mTextSize = HHDensityUtils.px2sp(context, textSize);
        }

        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, HHDensityUtils.dip2px(context, 1));
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.hh_pwd_gridpasswordview, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.hh_pwd_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.hh_pwd_textview, null);
