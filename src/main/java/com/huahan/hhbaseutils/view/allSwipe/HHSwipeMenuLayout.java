package com.huahan.hhbaseutils.view.allSwipe;
 ...
 * Date: 16/04/24
 */
public class HHSwipeMenuLayout extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static HHSwipeMenuLayout mViewCache;
    ...
    public HHSwipeMenuLayout(Context context) {
        this(context, null);
    }

    public HHSwipeMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HHSwipeMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public HHSwipeMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public HHSwipeMenuLayout setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static HHSwipeMenuLayout getViewCache() {
        return mViewCache;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = HHSwipeMenuLayout.this;
