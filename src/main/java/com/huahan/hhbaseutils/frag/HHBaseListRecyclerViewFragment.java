...
public abstract class HHBaseListRecyclerViewFragment<T> extends
    ...
    private int mLastVisibleItem;//最后一个可见item
    ...
    //
    public boolean load_more = true;// 是否需要加载更多功能
    public boolean refresh = true;// 是否需要下拉功能
    ...
    public void initValues() {
        ...
        linearLayoutManager = new LinearLayoutManager(getPageContext());
        gridLayoutManager = new GridLayoutManager(getPageContext(), count);
        ...
        if (setItemDecoration() >= 0) {
            ...
            recyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
                ...
                public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
                    ...
                    if (adapter.isHeaderViewPos(posi) || adapter.isFooterViewPos(posi)) {
                        if (posi == 0) {
                            outRect.left = 0;
                            outRect.right = 0;
                            outRect.top = 0;
                        } else {
                            outRect.left = itemPad;
                            outRect.right = itemPad;
                            outRect.top = itemPad;
                        }
                    } else {
                        if ((posi - adapter.getHeadersCount()) % 2 == 0) {
                            outRect.left = itemPad;
                    ...
                    .addOnScrollListener(new RecyclerView.OnScrollListener() {
                        ...
                        public void onScrolled(RecyclerView recyclerView,
                            ...
                            if (recyclerView.getLayoutManager() instanceof LinearLayoutManager) {
                                ...
                                View fristView = recyclerView.getLayoutManager()
                                        .getChildAt(0);
                                mLastVisibleItem = recyclerView
                                        .getLayoutManager().getPosition(fristView);
     ...
     * @return
     */
    protected abstract void getListDataInThread(int pageIndex, HHCallBackImp callBackImp);
